...
public class defaultOutOfBoundsAuto extends SequentialCommandGroup {
  /** Creates a new auto. */
  public defaultOutOfBoundsAuto(Swerve swerve, ShoulderSub x, ElbowSub y, WristSub z, PnuematicsSub a, IntakeSub b) {
