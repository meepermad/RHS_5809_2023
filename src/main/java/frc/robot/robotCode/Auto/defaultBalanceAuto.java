...
public class defaultBalanceAuto extends SequentialCommandGroup {
  /** Creates a new auto. */
  public defaultBalanceAuto(Swerve swerve, ShoulderSub x, ElbowSub y, WristSub z, PnuematicsSub a, IntakeSub b) {
